...
_****_![](<../../.gitbook/assets/image (17) (1) (1) (1).png>)_****_
...
![Burp Capture](<../../.gitbook/assets/image (18) (1) (1).png>)
...
<mark style="color:red;background-color:yellow;"></mark>![](<../../.gitbook/assets/image (12) (1) (1).png>)<mark style="color:red;background-color:yellow;"></mark>![](<../../.gitbook/assets/image (9) (1) (1).png>)<mark style="color:red;background-color:yellow;"></mark>
...
* Create a normal `http` listener on Attacker host + Setting up a Hop Listener on the compromised Linux host\
  ...
  ![](<../../.gitbook/assets/image (10) (1).png>)![](<../../.gitbook/assets/image (12).png>)
* Create a stager for `http_hop` and send from BurpSuite for waiting agent to receive!\
  \
  ![](<../../.gitbook/assets/image (7) (1) (1).png>)![](<../../.gitbook/assets/image (8) (1).png>)![](<../../.gitbook/assets/image (14) (1).png>)\
